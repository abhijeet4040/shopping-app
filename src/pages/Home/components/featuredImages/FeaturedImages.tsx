  ...
  return (
    <div className='lg:flex hidden '>
      <div>
        ...
        <img className='w-[228px] h-[150px] absolute bottom-[267px] left-[433px] hidden xl:block' src={SummerEssentials} alt="#" />
      </div>
      <div className='flex-1 bg-blue-400 flex-col flex justify-center items-center gap-[32px]'>
        <p className='text-white text-center font-lato font-bold text-3xl leading-10 uppercase '>Kimonos, Caftans & Pareos</p>
